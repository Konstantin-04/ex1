...
$form['feedback_form'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Сообщение с сайта "PROAUTO"',
		'title' => 'Сообщение с сайта "PROAUTO"',
		'ajax' => true,
		'validate' => true,
...
$form['callback_form'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Заказ обратного звонка с сайта "PROAUTO"',
    'title' => 'Заказ обратного звонка с сайта "PROAUTO"',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@your_domain.ru',
    'from_name' => 'your_domain.ru',
...
$form['order_form1'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Заявка с сайта "PROAUTO"',
    'title' => 'Заявка с сайта "PROAUTO"',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@your_domain.ru',
    'from_name' => 'your_domain.ru',
...
$form['eva_form'] = array(
  ...
  'cfg' => array(
    'charset' => 'utf-8',
    'subject' => 'Заказ эвакуатора с сайта "PROAUTO"',
    'title' => 'Заказ эвакуатора с сайта "PROAUTO"',
    'ajax' => true,
    'validate' => true,
    'from_email' => 'noreply@your_domain.ru',
    'from_name' => 'your_domain.ru',
